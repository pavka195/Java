package main.java.synergy.block01.lesson04;
...
public class Runner {
    ...
    Каждое из этих чисел должно соответствовать числу из ряда Фибоначчи так, что значение
    соответствующего элемента берется из буфера/кэша/массива, если такой элемент представлен
    или рассчитывается по алгоритму ряда Фибоначчи и размещается в этом кэше
     */
    ...
    public static BigInteger @NotNull [] fibonacci(int numUserFibonacci) {
